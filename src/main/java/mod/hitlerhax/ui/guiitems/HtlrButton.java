...
public class HtlrButton extends Gui {
	...
	public HtlrButton(int buttonId, int x, int y, String buttonText) {
		this(buttonId, x, y, 200, 20, buttonText);
	}

	public HtlrButton(int buttonId, int x, int y, int widthIn, int heightIn, String buttonText) {
		this.width = 200;
		this.height = 20;
		this.enabled = true;
		this.visible = true;
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks) {
		if (this.visible) {
			...
			FontUtils.drawString(displayString, mouseX, mouseY, new ColorUtil(j));
		}
	}
